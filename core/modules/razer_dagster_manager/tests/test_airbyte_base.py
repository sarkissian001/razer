...
#
# from ..src.airbyte_base.airbyte_base import AirByteBase
...
#         }
#
#     @patch("razer_airbyte_dagster.airbyte_base.airbyte_base.aiohttp.ClientSession.post")
...
#         )
#
#     @patch("razer_airbyte_dagster.airbyte_base.airbyte_base.AirByteBase.get_workspaces")
...
#
#     @patch(
#         "razer_airbyte_dagster.airbyte_base.airbyte_base.AirByteBase.get_all_connector_names"
#     )
#     @patch("razer_airbyte_dagster.airbyte_base.airbyte_base.aiohttp.ClientSession.post")
