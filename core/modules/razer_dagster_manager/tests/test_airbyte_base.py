...
from razer_dagster_manager.airbyte_base.airbyte_base import AirByteBase
from razer_dagster_manager.Enums.airbyte_connector_types import ConnectionType
...
class TestAirByteBase(TestCase):
    ...
    @patch("razer_dagster_manager.airbyte_base.airbyte_base.aiohttp.ClientSession.post")
    ...
    @patch("razer_dagster_manager.airbyte_base.airbyte_base.AirByteBase.get_workspaces")
    ...
    @patch("razer_dagster_manager.airbyte_base.airbyte_base.aiohttp.ClientSession.post")
    async def test_get_ws_connections(self, mock_session):
        expected_data = {
            "connections": [
                {
        ...
        actual_response = await self.airbyte_base.get_ws_connections(
            workspace_id="500f6675-e1a7-4408-b736-f69d15871b6f"
        )

        self.assertEqual(actual_response[0]["connectionId"], expected_customer_id)
    ...
    @patch(
        "razer_dagster_manager.airbyte_base.airbyte_base.AirByteBase.get_all_connector_names"
    )
    @patch("razer_dagster_manager.airbyte_base.airbyte_base.aiohttp.ClientSession.post")
